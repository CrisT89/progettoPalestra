...
{
    public class CategoryLookupService: LookupService
    {
        public CategoryLookupService(DatabaseContext context): base(context) { }

        public override List<IBaseEntity> GetEntitiesFromType(List<ComplexLinqPredicate> entityLinqPredicates)
        {
            return base.GetEntities<Category>(entityLinqPredicates);
        }
    }
}
