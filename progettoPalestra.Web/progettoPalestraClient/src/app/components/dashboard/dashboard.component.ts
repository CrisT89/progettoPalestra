...
import { FilterConfig, FilterCvlConfig, FilterSizeClass, InputType, WherePartType } from '@eqproject/eqp-filters';
...
export class DashboardComponent implements OnInit {
  ...
  configureFilters() {
    ...
    let cvlConfig: FilterCvlConfig = FilterCvlConfig.CreateFilterCVLConfig(null, [{ key: 1, value: "Valore 1" }, { key: 2, value: "Valore 2" }, { key: 3, value: "Valore 3" }], "key", "value", true, true, true, null, false);
    let cvlFilter: FilterConfig = FilterConfig.CreateStandardFilterConfig("PROVA_CVL", "Cvl", "CvlValue", InputType.Cvl, WherePartType.Equal, null, cvlConfig);
    ...
    let booleanCvlConfig: FilterCvlConfig = FilterCvlConfig.CreateFilterCVLConfig(null, [{ key: true, value: "Si" }, { key: false, value: "No" }], "key", "value", false, true, true, null, false);
    let booleanCvlFilter: FilterConfig = FilterConfig.CreateStandardFilterConfig("PROVA_CVL_BOOLEAN", "Boolean Cvl (Si/No/Tutti)", "BooleanCvlValue", InputType.BooleanCvl, WherePartType.Equal, null, booleanCvlConfig);
